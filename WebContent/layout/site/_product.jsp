...
<main class="container product" id="product">
    <h1 class="text-center product-text">SẢN PHẨM</h1>
	            ...
	            <div class="card p-2">
	                ...
	                <div class="content">
	                    ...
	                    <div class="buttons d-flex justify-content-center"> 
	                        ...
	                        <a href="invoices?product=${product.id}&quantity=1" class="btn btn-outline-danger mr-1">Mua ngay</a> 
			...
			<c:if test="${totalRecords > 8}">
				<ul class="pagination">
					...
					<c:if test="${currentPage > 1}">
					    <li class="page-item">
					        <a class="page-link" href="<c:url value='/product'/>?page=${currentPage - 1}">Previous</a>
					    </li>
					</c:if>
					...
					<c:forEach begin="${startPage}" end="${endPage}" var="page">
					    <li class="page-item">
					        <a class="page-link" 
					           ...
					           href="<c:url value='/product'/>?page=${page}">${page}</a>
					    </li>
					</c:forEach>
					
					<c:if test="${currentPage < totalPages}">
					    <li class="page-item">
					        <a class="page-link" href="<c:url value='/product'/>?page=${currentPage + 1}">Next</a>
					    </li>
					</c:if>
