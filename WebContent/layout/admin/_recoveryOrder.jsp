...
<div class="p-4 recovery-order">
	<h3>Các đơn hàng đã hủy</h3>
	...
	<table class="table table-hover table table-striped container">
	  ...
	  <c:forEach var="order" items="${orderList }">
	    <tr>
	      ...
	      <td>
	        <a href="admin/recovery-order?idOrder=${order.id }" style="color: green"><i class="fas fa-undo"></i></a> 
	      </td>
	      <td>
